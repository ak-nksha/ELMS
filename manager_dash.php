<?php
session_start();
if (!isset($_SESSION['userid']) || $_SESSION['position'] !== 'manager') {
...
<div class="dash">
    <header>
        ...
        <h2>Welcome, <?php echo $userid; ?> (Manager)</h2>
    ...
    <div class="group">
            ...
            <button onclick="manage_leaves()">Manage Leaves</button>
...
<script>
    ...
    function back(){
            window.location.href = "manager_dash.php";
            }
